...
// inherit from ListeningTest
function MushraNoAudio(TestData) {
    ListeningTest.apply(this, arguments);
}
MushraNoAudio.prototype = new ListeningTest();
MushraNoAudio.prototype.constructor = MushraNoAudio;
...
// ###################################################################
// create random mapping to test files
MushraNoAudio.prototype.createFileMapping = function (TestIdx) {
    var NumFiles = $.map(this.TestConfig.Testsets[TestIdx].Files, function(n, i) { return i; }).length;
    var fileMapping = new Array(NumFiles);    
...
// ###################################################################
// read ratings from TestState object
MushraNoAudio.prototype.readRatings = function (TestIdx) {
...
// ###################################################################
// save ratings to TestState object
MushraNoAudio.prototype.saveRatings = function (TestIdx) {
    var ratings = new Object();
    $(".rateSlider").each( function() {
        var pos = $(this).attr('id').lastIndexOf('slider');
        var fileNum = $(this).attr('id').substring(pos+6, $(this).attr('id').length);
...
MushraNoAudio.prototype.createTestDOM = function (TestIdx) {
        ...
        cell[0].innerHTML = "<p align='left'>"+this.TestConfig.Testsets[TestIdx].Text+"</p>";
        cell[0].colSpan = 5; 
        ...
        for (var i = 0; i < this.TestState.FileMappings[TestIdx].length; i++) { 
            ...
            cell[3].innerHTML = "<div class='rateSlider' id='slider"+fileID+"' rel='"+fileID+"'>"+fileIDstr+"</div>";
            // cell[3].colSpan=3;
...
MushraNoAudio.prototype.formatResults = function () {
...
// inherit from ListeningTest
function MushraLabel(TestData) {
    ListeningTest.apply(this, arguments);
}
MushraLabel.prototype = new ListeningTest();
MushraLabel.prototype.constructor = MushraLabel;
...
// ###################################################################
// read ratings from TestState object
MushraLabel.prototype.readRatings = function (TestIdx) {
...
// ###################################################################
// save ratings to TestState object
MushraLabel.prototype.saveRatings = function (TestIdx) {
    var ratings = new Object();
    $(".rateSlider").each( function() {
        var pos = $(this).attr('id').lastIndexOf('slider');
        var fileNum = $(this).attr('id').substring(pos+6, $(this).attr('id').length);
...
MushraLabel.prototype.createTestDOM = function (TestIdx) {
        ...
        row  = tab.insertRow(-1);
        cell[0] = row.insertCell(-1);
        cell[0].innerHTML = "<span class='testItem'>Both Speakers (Stereo)</span>";
        cell[1] = row.insertCell(-1);
        cell[1].innerHTML =  '<button id="play'+fileID+'Btn" class="playButton" rel="'+fileID+'">Play</button>';
        cell[2] = row.insertCell(-1);
        cell[2].innerHTML = "<button class='stopButton'>Stop</button>";  	
        ...
        row  = tab.insertRow(-1);
        cell[0] = row.insertCell(-1);
        cell[0].innerHTML = "<span class='testItem'>Both Speakers (Mono)</span>";
        cell[1] = row.insertCell(-1);
        cell[1].innerHTML =  '<button id="play'+fileID+'Btn" class="playButton" rel="'+fileID+'">Play</button>';
        cell[2] = row.insertCell(-1);
        cell[2].innerHTML = "<button class='stopButton'>Stop</button>";  	
...
MushraLabel.prototype.formatResults = function () {
