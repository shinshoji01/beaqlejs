...
MushraTest.prototype.createTestDOM = function (TestIdx) {
        ...
        cell[0].innerHTML = "<p align='left'><b>Transcript</b>: "+this.TestConfig.Testsets[TestIdx].Text+"</p>";
        cell[0].colSpan = 4; 
...
PrefTest.prototype.createTestDOM = function (TestIdx) {
        ...
        row  = tab.insertRow(-1);
        cell[0] = row.insertCell(-1);
        cell[0].innerHTML = "<p align='left'>aaa"+this.TestConfig.Testsets[TestIdx].Text+"</p>";
        cell[0].colSpan = 5; 
